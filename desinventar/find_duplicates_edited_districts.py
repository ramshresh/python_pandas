...
excel_file_drr = r"C:\learn2code\desinventar\drr_not_in_desinventar.xlsx"
...
drr_not_in_desinventar.to_csv('drr_not_in_desinventar_final_districts_edited.csv', index=False)


mask2 = drr['S.No.'].isin(dup_date_district_incident_list)
drr_maybe_in_desinventar = drr[mask2]
drr_maybe_in_desinventar.to_csv('drr_maybe_in_desinventar_final_districts_edited.csv', index=False)
